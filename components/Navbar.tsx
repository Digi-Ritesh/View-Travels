          ...
          >
            ...
            <ul className="py-2" aria-labelledby="user-menu-button">
              ...
              <li>
                <Link
                  ...
                  className={`block px-4 py-2 text-sm ${pathname === "/settings"
                    ? "bg-gray-200 text-blue-600" : "text-gray-700 hover:bg-gray-100"}`}
                >
                  Settings
                </Link>
              </li>
              ...
              <li>
                <Link
                  href="/earnings"
                  className={`block px-4 py-2 text-sm ${pathname=== "/earnings" ? "bg-gray-200 text-blue-600" : "text-gray-700 hover:bg-gray-100"}`}
                >
                  Earnings
                </Link>
              </li>
